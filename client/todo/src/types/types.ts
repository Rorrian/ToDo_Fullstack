...
// Указываем дженерик T, т.к. тип может быть ITodo | string
...
export type ITodoAction =
  ...
  | ICreateAction
  | IDeleteAction
  | ICompleteAction<ITodo | string> // В payload могут быть массив todos или id(string)
  | IEditAction
